    ...
    <div class="scrollbar-wrapper">
        <div>
            ...
            <ul class="metisMenu nav" id="side-menu">
                <li><router-link to="/inicio" class="seleccion"><i class="fa fa-home"></i> Dashboard</router-link></li>
                ...
                @if (auth()->check() && auth()->user()->hasRoles(['1','3']))
                    <li>
                        ...
                        <ul class="nav-second-level nav" aria-expanded="true">
                            <router-link to="/categoria" class="boton-navegacion seleccion">Categoria</router-link>
                            {{-- <li @click="menu=1"><a class="seleccion" href="javascript:void(0)">Categoria</a></li> --}}
                            <router-link to="/articulo" class="boton-navegacion seleccion">Articulos</router-link>
                ...
                @if (auth()->check() && auth()->user()->hasRoles(['1','3']))
                    <li>
                        ...
                        <ul class="nav-second-level nav" aria-expanded="true">
                            <router-link to="/ingreso" class="boton-navegacion seleccion">Ingresos</router-link>
                            <router-link to="/proveedor" class="boton-navegacion seleccion">Proveedores</router-link>
                ...
                @if (auth()->check() && auth()->user()->hasRoles(['1','2']))
                    <li>
                        ...
                        <ul class="nav-second-level nav" aria-expanded="true">
                            <router-link to="/venta" class="boton-navegacion seleccion">Ventas</router-link>
                            <router-link to="/cliente" class="boton-navegacion seleccion">Clientes</router-link>
                ...
                @if (auth()->check() && auth()->user()->hasRoles(['1']))
                    <li>
                        ...
                        <ul class="nav-second-level nav" aria-expanded="true">
                            <router-link to="/usuario" class="boton-navegacion seleccion">Usuarios</router-link>
                            <router-link to="/rol" class="boton-navegacion seleccion">Roles</router-link>
                ...
                @if (auth()->check() && auth()->user()->hasRoles(['1','2']))
                    <li>
                        ...
                        <ul class="nav-second-level nav" aria-expanded="true">
                            <router-link to="/consultaingreso" class="boton-navegacion seleccion">Reporte Ingresos</router-link>
                            <router-link to="/consultaventa" class="boton-navegacion seleccion">Reporte Ventas</router-link>
