                ...
                <div id="datatable-buttons_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                    ...
                    <div class="dataTables_filter">
                        <label>
                            ...
                            <input type="search" v-model="buscar" v-on:keypress="listarArticulo(1,buscar)" class="form-control input-sm" placeholder="" aria-controls="datatable-buttons" >
                        ...
                        <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                            ...
                            <td>
                                ...
                                <template v-if="articulo.condicion">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Desactivar" @click="desactivarCategoria(articulo.id)" ><i class="fa fa-trash-alt"></i></button>
                                </template>

                                <template v-else>
                                    <button type="button" class="btn btn-sm btn-success"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Activar" @click="activarCategoria(articulo.id)"><i class="fa fa-check"></i></button>
                                </template>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="email-input">Precio Ventan</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" v-model="precio_venta" class="form-control" placeholder="Ingrese el numero de elementos">
                            </div>
                        </div>
                        <div class="form-group row">
