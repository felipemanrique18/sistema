...
<style>    
    ...
    .ventas-agregadas {
        ...
        padding-top: 50px;
        padding-bottom: 50px;
        -webkit-box-shadow: 0px 2px 13px -2px rgba(113, 113, 113, 0.59);
        -moz-box-shadow: 0px 2px 13px -2px rgba(0,0,0,0.59);
        box-shadow: 0px 2px 13px -2px rgba(191, 191, 191, 0.7);
    }
</style>
